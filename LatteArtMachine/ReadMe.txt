================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: LatteArtMachine プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した LatteArtMachine には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには LatteArtMachine アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

LatteArtMachine.vcproj
...
LatteArtMachine.h
   ...
   CLatteArtMachineApp アプリケーション クラスを宣言します。

LatteArtMachine.cpp
   これは、アプリケーション クラス CLatteArtMachineApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\LatteArtMachine.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル LatteArtMachine.rc に含まれていま
   す。

res\LatteArtMachine.rc2
...
LatteArtMachineDlg.h, LatteArtMachineDlg.cpp - ダイアログ
   これらのファイルは CLatteArtMachineDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な LatteArtMachine.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   LatteArtMachine.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
